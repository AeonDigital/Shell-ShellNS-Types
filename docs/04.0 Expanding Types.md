...
The brackets positioned next to the name of a type indicate that the return 
will be a list of values of that type, whose separator will be the string 
defined inside, and may even be a blank space.  
